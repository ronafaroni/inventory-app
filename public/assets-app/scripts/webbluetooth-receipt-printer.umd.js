    ...
    "object" == typeof exports && "undefined" != typeof module
        ...
        : ((e =
              "undefined" != typeof globalThis
                  ? globalThis
                  : e || self).WebBluetoothReceiptPrinter = t());
})(this, function () {
    "use strict";
    class e {
        constructor(e) {
    ...
    return class extends s {
        ...
        async connect() {
            let e = i.map((e) => e.filters).reduce((e, t) => e.concat(t)),
                t = i
                    .map((e) =>
                        Object.values(e.functions).map((e) => e.service)
                    )
        ...
        async reconnect(e) {
            ...
            let t = (await navigator.bluetooth.getDevices()).find(
                (t) => t.id == e.id
            );
            t && (await this.#c(t));
        }
        async #c(e) {
            ...
            if (
                ...
                let e = await t.getPrimaryService(
                    this.#s.functions.status.service
                );
        ...
        #r(e, t) {
            if (e.services)
                for (let i of e.services) if (!t.includes(i)) return !1;
            return (
        ...
        async listen() {
            return (
                ...
                this.#a.status.addEventListener(
            ...
            return new Promise((t) => {
                ...
                for (let t of e) {
                    ...
                    if (1 === i) {
                        let e = t;
                        this.#t.add(() =>
                            this.#a.print.writeValueWithResponse(e)
                        ),
                        ...
                        for (let s = 0; s < i; s++) {
                            let i = s * e,
                                ...
                                c = t.slice(i, a);
                            this.#t.add(() =>
                                this.#a.print.writeValueWithResponse(c)
                            ),
                                this.#s.sleepAfterCommand &&
                                    this.#t.sleep(this.#s.sleepAfterCommand);
                        }
