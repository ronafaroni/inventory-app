                            ...
                            <div class="col-lg-12 col-md-6 col-sm-12">
                                ...
                                <form id="dataForm">
                                    ...
                                    <div class="input-block mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <select name="kode_sales" id="kode_sales" class="form-control form-small">
                                                <option value="" selected>Masukan Kode Sales</option>
                                    ...
                                    <div class="input-block mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <select name="kode_item" id="kode_item" class="form-control form-small">
                                                <option value="" selected>Masukan Jenis Item</option>
                                    ...
                                    <div class="input-block mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" name="tambah_stok" id="tambah_stok" class="form-control" placeholder="Tambah Stok (pcs)" value="">
                                            @error('tambah_stok')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <a class="btn btn-import" href="{{ route('riwayat-sales') }}">
...
<script>
    ...
    $('#addData').on('click', function() {
        ...
        $('#kode_sales').prop('selectedIndex', 0);  // Reset dropdown to default
        $('#kode_item').prop('selectedIndex', 0);  // Reset dropdown to default
        $('#tambah_stok').val('');  // Clear input field
    });
    ...
    function updateTable() {
        ...
        dataArray.forEach((data, index) => {
            totalStok += parseInt(data.tambahStok, 10);
            tableBody.append(`
                <tr>
                    <td>${index + 1}</td>
                    <td>${data.kodeItem}</td>
                    <td>${data.namaItem}</td>
                    <td>${formatRupiah(data.tambahStok)}</td>
                    <td class="d-flex">
        ...
        $('#totalStok').text(formatRupiah(totalStok));
    }
