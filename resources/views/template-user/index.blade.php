                        ...
                        <a href="javascript:void(0)" class="user-link  nav-link" data-bs-toggle="dropdown">
							...
							<span class="user-content">
								@if(Auth::guard('sales')->check())
									<span class="user-details">{{ Auth::guard('sales')->user()->kode_sales }}</span>
									<span class="user-name">{{ Auth::guard('sales')->user()->nama_sales }}</span>
								@endif
							</span>
                        </a>
				...
				<div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul class="sidebar-vertical">
							<li class="menu-title"><span>Main Menu</span></li>
							<li>
								<a href="{{ route('toko-sales') }}" class="{{ request()->routeIs('toko-sales') ? 'active' : '' }}"><i class="fe fe-home"></i> <span> Toko</span></a>
							</li>

							<li>
								<a href="{{ route('kunjungan') }}" class="{{ request()->routeIs('kunjungan') ? 'active' : '' }}"><i class="fe fe-shopping-cart"></i> <span> Kunjungan</span></a>
							</li>

							<li>
								<a href="{{ route('profile') }}" class="{{ request()->routeIs('profile') ? 'active' : '' }}"><i class="fe fe-user"></i> <span> Profile</span></a>
							</li>
						</ul>
					</div>
				</div>
